...
$organization_name = mysqli_real_escape_string($db,$obj->{'organization_name'});
$postal_address = mysqli_real_escape_string($db,$obj->{'postal_address'});
$address = $obj->{'address'};
...
else
{
 ...
 $sql="INSERT INTO `tbl_ngoz`(`organization_name`,`postal_address`,`latitude`,`longitude`,`constitution`,`registration_ticket`) VALUES ('$organization_name','$postal_address','$latitude','$longitude','$name','$registration_ticket')";
 if(mysqli_query($db,$sql))
 {
    foreach ($founders as $shareholder) {
        $id = $shareholder->id;
        ...
        $sql="INSERT INTO `tbl_ngoz_founders`(`id_founder`,`full_name`,`phone_number`,`position`,`identification_number`,`registration_ticket`) VALUES ('$id','$full_name','$phone_number','$position','$identification_number','$registration_ticket')";
        if(!mysqli_query($db,$sql))
         {
             die($sql);
         }
